package io.github.cottonmc.jsonfactory.gens.block.leaf
...
internal object LeafLootTable : ContentGenerator("Leaf Loot Table", "loot_tables/blocks",
                                ...
                                children = listOf(
                                    ...
                                    Entry(
                                        ...
                                        conditions = listOf(
                                            ...
                                            Condition.TableBonus(Identifier.mc("fortune"), chances = listOf(
                    ...
                    Pool(
                        entries = listOf(
                            Entry(
                                ...
                                conditions = listOf(Condition.TableBonus(Identifier.mc("fortune"), chances = listOf(
                                    0.02,
                                    0.022222223,
                                    0.025,
                                    0.033333335,
                            ...
                            Condition.Inverted(
                                Condition.Alternative(
                                    listOf(
                                        ...
                                        Condition.MatchTool(predicate = mapOf("enchantments" to listOf(
                                            mapOf(
                                                "enchantment" to Identifier.mc("silk_touch"),
                                                "levels" to mapOf("min" to 1)
                                            )
